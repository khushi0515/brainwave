...
import { BackgroundCircles, ButtomLine, Gradient } from "./design/Hero";
        ...
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
          <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
            <div className="relative bg-n-8 rounded-[1rem]">
              <div className="h-[1.4rem] bg-n-10 rounded-t-[0.9]" />
              ...
              <div className="aspect-[33/40] rounder-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                ...
                <Generating className="absolute left-4 right-4 bottom-5 md:left-1/2 md:right-auto md:buttom-8 md:w-[31rem] md:-translate-x-1/2" />
